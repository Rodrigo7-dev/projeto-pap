// API completa para deploy no Railway
...
app.listen(port, () => {
  ...
  console.log('- PUT /api/processos/:id');
  console.log('- DELETE /api/processos/:id');
  console.log('- GET /api/ruas');
  console.log('- POST /api/ruas');
  console.log('- PUT /api/ruas/:id');
  console.log('- DELETE /api/ruas/:id');
  console.log('- GET /api/freguesias');
  console.log('- POST /api/freguesias');
  console.log('- PUT /api/freguesias/:id');
  console.log('- DELETE /api/freguesias/:id');
  console.log('- GET /api/tipopublicidade');
  console.log('- POST /api/tipopublicidade');
  console.log('- PUT /api/tipopublicidade/:id');
  console.log('- DELETE /api/tipopublicidade/:id');
});
